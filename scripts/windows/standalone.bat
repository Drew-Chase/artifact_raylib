...
if not exist "bin\obj\bundled" mkdir "bin\obj\bundled"
cd "bin\obj\bundled"

:: Configure and build
cmake -DCMAKE_TOOLCHAIN_FILE="%VCPKG_ROOT%\scripts\buildsystems\vcpkg.cmake" -DPROFILE_NAME=bundled -DREMOVE_DEBUG_INFO=ON -G "Ninja" ..\..\..
cmake --build . -j 32
